<? front_header(); 
$rdata = $this->db->get_where("tbl_ripf_registrations",["id"=>$this->session->userdata("ripfuser_id"),"registration_status"=>"Active"])->row();
...
<!--   				<img src="<? echo base_url('assets/images/check.png') ?>" width="40%"><br><br>-->
   				...
   				<a href="<? echo base_url('ripf/addParticipants/').$rdata->event_name ?>" class="btn btn-primary" style="border-radius: 10px;">Add Participants</a>
