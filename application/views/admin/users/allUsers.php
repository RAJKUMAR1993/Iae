...
<link rel="stylesheet" href="https://cdn.datatables.net/buttons/1.6.0/css/buttons.dataTables.min.css">
 ...
 ?>
			<h5 class="txt-dark">List of <?php  echo $online->type;?> Users </h5>
		</div>
					<!-- Breadcrumb -->
		<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
			<ol class="breadcrumb">
				...
				<li class="active"><span>Online Registered Users</span></li>
			</ol>
		</div>
					<!-- /Breadcrumb -->
	</div>	
				...
				<div class="row">
              		...
              		<div class="row">
						 ...
						 <div class="form-group col-md-5">
            				...
            				<div class="col-md-3">
            					<a class="btn btn-primary" href="<? echo base_url('admin/users') ?>">Clear</a>
            				</div>
										...
										<table class="table table-hover display  pb-30" id="myTable">
											...
											<?
	                                          ...
	                                          $sdata = json_decode($row->event_data);	
													...
													if($this->input->get("ref_type") != "" ||$this->input->get("cref") != "" || $odata->payment_type == "online"){
											...
											<?			
													...
													foreach($part as $pc => $p){  
														$discount_amount = ($odata->total_discount_amount > 0) ? ($odata->total_discount_amount - $odata->total_amount) : $odata->total_discount_amount;
