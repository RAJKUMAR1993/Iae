	...
	<div class="row heading-bg">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h5 class="txt-dark"><? echo isset($s->id) ? 'Update' : 'Add' ?> Stream</h5>
		</div>
					<!-- Breadcrumb -->
		<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
			<ol class="breadcrumb">
				<li><a href="<?php echo base_url() ?>admin/dashboard">Dashboard</a></li>
				<li><a href="<?php echo base_url() ?>admin/Categories">Streams</a></li>
				<li class="active"><span><? echo isset($s->id) ? 'Update' : 'Add' ?> Stream </span></li>
			</ol>
		</div>
					<!-- /Breadcrumb -->
	</div>	
						...
						<div class="panel panel-default card-view">
							...
							<div class="panel-wrapper collapse in">
						        ...
						        <div class="container">
						         ...
						         <form method="post" action="<? echo base_url('admin/Streams/insertData') ?>" enctype="multipart/form-data">
								   ...
								   <div id="error"></div>
									  ...
									  <div class="col-md-3">
										...
										<div class="form-group">
										  <input type="text" class="form-control" placeholder="Stream Name" value="<? echo isset($s->category) ? $s->category : '' ?>" name="category" required>
										</div>
									  </div>
									  <div class="col-md-5">
									  	<label>Events</label>
