        ...
        <div class="col-md-12  black">
          ...
          <div class="container register-form">
            ...
            <? if(($cdate < $edata->registration_end_date) && ($edata->status == "Active")){ ?>		
              ...
              <div class="note">
                <h1 style="padding-top: 15px;"> Online Registration (<? echo $this->uri->segment(3) ?>)</h1>
                <p>(<? echo $edata->event_name ?>)</p>
              </div>
...
<!--										<option value="Others">Others</option>-->
                  ...
                  <div class="col-md-12">
					...
					?>
					<strong>
					<small style="color: red">Note : <?php echo $discount[0]->Government;?>% Discount is available for Government Institutions.</small>
					</strong>
					<?php }else { ?>
					<strong>
					<small style="color: red">Note : <?php echo $discount[0]->Government;?>% Discount is available for Government and <?php echo $discount[0]->Government_Aided;?>% Discount for Government-Aided.</small>
					</strong>
					<?php } ?>
                  ...
                  <div class="col-md-12">
                    <div class="form-group checkbox-group required">
                      ...
                      <div class="checkbox">
						 ...
						 ?>	
							<label>
							  <input type="checkbox" class="topic getPrice" name="topic[]" value="<? echo $t->topic_name ?>" <? if(in_array("$t->topic_name",$mdetails)){ echo 'checked'; } ?> ><? echo $t->topic_name." - <i class='fa fa-rupee'></i> ".$t->amount ?></label><br>
                    	 <? } ?>
                    	 <label>
							  <input type="checkbox" class="getPrice" id="select_all" name="topic[]" value="all" <? if(in_array("all",$mdetails)){ echo 'checked'; } ?> >All  - <i class='fa fa-rupee'></i> <? echo $cdata->overall_discount_amount ?></label>		 
                      </div>
              ...
              <? } ?>    
                ...
                <div class="row">
                	<div class="col-md-6">
						<h2 class="pull-left" id="participationPrice" style="width:100%"> <strong>Participation Fee - <i class="fa fa-rupee"></i> <? echo $package->package_amount ?></strong></h2> 
						<h2 class="pull-left" id="discountPrice" style="display: none;width:100%"> <strong>Discount Amount - <i class="fa fa-rupee"></i> <? echo $package->package_amount ?></strong></h2> 
						<h2 class="pull-left" id="totalPrice" style="display: none;width:100%"> <strong>Fee to be paid after Discount - <i class="fa fa-rupee"></i> <? echo $package->package_amount ?></strong></h2> 
					</div>
					
					<div class="col-md-6">
						<input type="hidden" name="event_category" value="<? echo $this->uri->segment(3) ?>"> 
						<input type="hidden" name="event_name" value="<? echo explode("~",$this->uri->segment(4))[1] ?>">
...
<script type="text/javascript">
	...
	$("#formdata").on("submit",function(e){
		...
		$.ajax({
			...
			"type" : "post",
			data : data,
			url : "<? echo base_url('ripf/insertData') ?>",
			success : function(data){
