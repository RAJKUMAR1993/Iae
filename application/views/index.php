...
.news-scroll-left {
    background: url(<? echo base_url() ?>assets/images/newsbg.png) right top no-repeat;
    line-height: 45px;
    height: 45px;
    font-size: 15px;
    font-weight: 500;
...
<? 
	$updates = $this->db->get_where("tbl_updates")->result();
	if(count($updates) > 0){		   
?>		
		...
		<div class="news-scroll">
			<div class="container">
				<div class="row">
					<div class="col-md-2 col-sm-2 col-xs-12 news-scroll-left">Updates</div>
								...
								<div class="marquee">
									<ul class="marquee-content-items">
										<? foreach($updates as $u){ ?>	
											<li>
												<? if($u->link){ ?>
													<a href="<? echo base_url().$u->link ?>" style="color: black"><? echo $u->title ?></a>
												<? }else{  
													echo $u->title;
												 } ?>		
											</li>
...
<section class="aboutus white-background black" id="one" style="padding: 20px;">
  <div class="container">
	  ...
	  <div class="col-lg-6"> <div class="avbox">
		 <h2> NAAC Workshop </h2>
		  <p><strong>24<sup>th</sup> & 25<sup>th</sup> May 2021</strong></p>
		  <ul>
			  <li>Universities</li>
			  <li>Autonomous Institutions</li>
			  <li>Affiliated Colleges</li>
			  <li>Health Science Institutions</li>
		  </ul>
		 <br>
	   ...
	   <div class="col-lg-6">
		   ...
		   <p><strong>21<sup>st</sup> - 24<sup>th</sup> June 2021</strong></p>
		  <ul>
			  <!--<li>Engineering and Technology</li>
			  <li>Arts and Humanities</li>
			  <li>Science</li>
			  <li>Health and Life Sciences</li>
			  <li>Commerce and Business Management</li>-->
