			...
			<div class="row">
				<div class="panel-wrapper collapse in">
					<div class="card-view row" style="padding: 20px;">
						<?	
							$events = $this->db->get_where("tbl_schedule_dates",["status"=>"Active"])->result();
							foreach($events as $e){
						?>
							<div class="col-md-4">
								<div class="card">
									<div class="table table-info">
										<h4 class="card-caption">
											<a href="<? echo base_url('home/downloads/').$e->id ?>"><? echo substr($e->event_name,0,80) ?>...</a>
										</h4>
										...
										<div class="ftr text-center"> <a href="<? echo base_url('home/downloads/').$e->id ?>" class="btn btn-white btn-round">Download</a> </div>
									</div>
								</div>
							</div>
						<? } ?>	
